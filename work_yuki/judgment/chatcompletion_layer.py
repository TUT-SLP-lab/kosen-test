...
print_list = ["肯定的な回答", "否定的な回答", "添削した回答"]
prompt_list = [prompt_ture, prompt_false, prompt_remake]

#for i in range(3):
    #call_chatgpt(prompt_list[i], models[0], output, client_b)
    #print(print_list[i])
    #print(output[i+1])
...
print("否定的な回答")
print(output[2])
call_chatgpt(prompt_remake, models[0], output, client_b)
print("添削した回答")
print(output[3])
